    ...
    <div className="mx-auto">
      ...
      <div className="card mb-6 flex flex-col items-center gap-4 rounded-lg bg-white p-4 shadow-md dark:bg-slate-800 md:flex-row">
        <input
          ...
          className="w-full rounded-md border border-gray-300 bg-transparent px-4 py-2 text-gray-900 outline-none placeholder:text-slate-500 dark:border-slate-600 dark:text-slate-50 dark:placeholder-gray-400 md:flex-1"
        />
        <button
