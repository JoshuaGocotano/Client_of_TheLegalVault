        ...
        <div className="bg-blue rounded-xl p-6 shadow-sm dark:bg-slate-900">
            ...
            <div className="mb-6 flex flex-col items-center gap-4 md:flex-row">
                <input
                    ...
                    className="w-full rounded-md border border-gray-300 bg-gray-100 px-4 py-2 text-gray-900 dark:border-slate-600 dark:bg-slate-700 dark:text-white md:flex-1"
                />
                <button
